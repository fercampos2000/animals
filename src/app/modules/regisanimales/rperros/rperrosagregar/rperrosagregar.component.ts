...
@Component({
  selector: 'app-rperrosagregar',
  templateUrl: './rperrosagregar.component.html',
  styleUrls: ['./rperrosagregar.component.scss']
})
export class RperrosagregarComponent {
  ...
  public archivos : any = [];
     ...
     agregarPerro(nombre: string, edad: string, raza:string){
       let editarRpersona: any;
         ...
         this.http.agregRperro(editarRpersona).subscribe(result=>{
           if(result.message!==''){
