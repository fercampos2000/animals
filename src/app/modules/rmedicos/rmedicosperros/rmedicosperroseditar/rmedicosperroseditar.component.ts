...
@Component({
  selector: 'app-rmedicosperroseditar',
  templateUrl: './rmedicosperroseditar.component.html',
  styleUrls: ['./rmedicosperroseditar.component.scss']
})
export class RmedicosperroseditarComponent {
    ...
    ngOnInit() {
      ...
      editarRmedicoperro(nombre:string, agresividad: string, esterilizacion: string, vacuna1 : string,vacuna2: string, otro: string){
        let editarRpersona: any;
          ...
          this.http.editarRegistromedicosperro(editarRpersona).subscribe(result=>{
            if(result.message!==''){
