...
@Component({
  selector: 'app-rmedicosgatosagregar',
  templateUrl: './rmedicosgatosagregar.component.html',
  styleUrls: ['./rmedicosgatosagregar.component.scss']
})
export class RmedicosgatosagregarComponent {
      ...
      //agregar nuevo registro
         agregardatomedicogato(nombreanimal:string, agresividad: string, esterilizacion: string,vacuna1:string, vacuna2: string, otro: string){
           let agregarRmedicoperro: any;
             ...
             this.http.agregRegistromedicosgato(agregarRmedicoperro).subscribe(result=>{
               if(result.message!==''){
