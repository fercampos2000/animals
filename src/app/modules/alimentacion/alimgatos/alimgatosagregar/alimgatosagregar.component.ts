...
@Component({
  selector: 'app-alimgatosagregar',
  templateUrl: './alimgatosagregar.component.html',
  styleUrls: ['./alimgatosagregar.component.scss']
})
export class AlimgatosagregarComponent {
      ...
      //agregar nuevo registro
         agregaralimentoperro(sector1:string,
           ...
           let agregarRmedicoperro: any;
             ...
             this.http.agregAlimentaciongato(agregarRmedicoperro).subscribe(result=>{
               if(result.message!==''){
