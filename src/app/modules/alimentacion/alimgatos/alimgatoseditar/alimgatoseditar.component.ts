...
@Component({
  selector: 'app-alimgatoseditar',
  templateUrl: './alimgatoseditar.component.html',
  styleUrls: ['./alimgatoseditar.component.scss']
})
export class AlimgatoseditarComponent {
  ...
  ngOnInit() {
    ...
    this.http.getAlimentaciongato(this.ffecha).subscribe(data => {
    ...
    editarAlimperro(sector1:string,
      ...
      let editarRpersona: any;
        ...
        this.http.editarAlimentaciongato(editarRpersona, this.ffecha).subscribe(result=>{
          if(result.message!==''){
